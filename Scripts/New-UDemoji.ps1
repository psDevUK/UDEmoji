...
.EXAMPLE
    PS C:\> New-UDEmoji -Emoji ":smile:" -Height 100 -Width 100
    Creates a new emoji icon that is smiling and has a height of 100px and width of 100px
.INPUTS
    Inputs (if any)
.OUTPUTS
    Output (if any)
.NOTES
    Thought this would be useful for somewhere out there...and to help raise mental health awareness through the power of emoji
#>
function New-UDEmoji {
    param(
        [Parameter()]
        [string]$Id = (New-Guid).ToString(),
        [Parameter()]
        [ValidateSet(  ":grinning:",
            ":smiley:",
            ":smile:",
            ":grin:",
            ":laughing:",
